...
namespace Teste
{
    public partial class FormAdicionarVisitantes2 : Form
    {
        FormEditarVisitacao fev;
        void FillListBox()
        {
        ...
        public FormAdicionarVisitantes2(ListBox l, FormEditarVisitacao fevis)
        {
            InitializeComponent();
            FillListBox();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            fev.listBoxVisiantes.Items.Clear();
            fev.comboBoxResponsavel.Items.Clear();

            foreach (var item in listBoxAdicionados.Items)
            {
                fev.listBoxVisiantes.Items.Add(item);
                fev.comboBoxResponsavel.Items.Add(item);
            }
        }
    }
}
